...
$eventC=new EventC();
$listeEvenement=$eventC->afficherEvenements();


?>
		
		                      <form method="POST" action=" rechercheA.php">

<br/>
<h2>Recherche </h2>
<br/>
 <input value="<?PHP echo $row['id']; ?>" name="id" id="id">
...
foreach($listeEvenement as $row){
	...
	<td><a href=" Event-edit.php?id=<?PHP echo $row['id']; ?>">
