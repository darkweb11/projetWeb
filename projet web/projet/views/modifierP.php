...
<head>
    ...
    <title>MODIFIER PROMOTION | jeweler - Material Admin Template</title>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="DISPLAY EVENT" href="product-list.php"><i class="fa fa-female sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">DISPLAY EVENT</span></a></li>
                                <li><a title="ADD EVENT" href="product-edit.html"><i class="fa fa-bolt sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">ADD EVENT</span></a></li>
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="DISPLAY PROMOTION" href="blog.php"><i class="fa fa-square sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">DISPLAY PROMOTION</span></a></li>
                                <li><a title="ADD PROMOTION" href="blog-details.html"><i class="fa fa-tags sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">ADD PROMOTION</span></a></li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="product-list.php">DISPLAY EVENT</a></li>
                                                <li><a href="product-edit.html">ADD EVENT</a></li>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#others" href="#">Miscellaneous <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul id="others" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="blog.php">DISPLAY PROMOTION</a></li>
                                                <li><a href="blog-details.html">ADD PROMOTION</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">ADD PROMOTION</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
if (isset($_GET['id'])){
	...
	foreach($result as $row){
		...
		$Date=$row['Date'];
?>
                     <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> MODIFIER UNE PROMOTION</a></li>
                                     </ul>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" name="Produit" placeholder="Produit" value="<?PHP echo $Produit ?>">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-dollar" aria-hidden="true"></i></span>
                                                        <input type="number" class="form-control" name="PrixInit" placeholder="Pix Initiale" value="<?PHP echo $PrixInit ?>">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-dollar" aria-hidden="true"></i></span>
                                                        <input type="number" class="form-control" name="PrixFin" placeholder="Prix Finale" value="<?PHP echo $PrixFin ?>">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
